...
<section class="padding-y bg-light" style="min-height:90vh">
    <div class="container">
        ...
        <div class="card shadow mx-auto" style="max-width:400px; margin-top:40px;">
            <div class="card-body">
                <h4 class="mb-4" style="-webkit-user-select: none;">Login</h4>
                <form method="post" autocomplete="off">
                    <div class="mb-3">
                        <div class="alert-danger"><?php Functions::checkError(); ?></div>
                        <br>
                        <label class="form-label" style="-webkit-user-select: none;">Email</label>
                        <input name="email" class="form-control" style="-webkit-user-select: none;" placeholder="ex. name@gmail.com" type="email" autocomplete="off" required="required">
                    </div> <!-- col end.// -->
